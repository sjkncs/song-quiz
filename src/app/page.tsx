  ...
  return (
    <main className="min-h-[100dvh] flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="text-center mb-10 animate-fadeIn">
        <div className="w-20 h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-4xl shadow-lg shadow-blue-500/20">
      ...
      <div className="glass-card w-full max-w-sm p-6 space-y-5 animate-slideUp">
        ...
        {/* 昵称 */}
        <div>
          <label className="text-xs text-[var(--text-secondary)] mb-1.5 block">你的昵称</label>
          <input
            type="text"
            className="input-field"
            placeholder="输入昵称（显示在排行榜）"
            value={nickname}
      ...
      <p className="mt-8 text-xs text-[var(--text-secondary)] text-center max-w-xs">
        扫描现场二维码即可进入游戏。游戏过程中请勿切换至其他应用，否则将被记录。
      </p>
    </main>
  );
}
